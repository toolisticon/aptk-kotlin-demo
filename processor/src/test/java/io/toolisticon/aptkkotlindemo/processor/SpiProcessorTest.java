...
public class SpiProcessorTest {
    ...
    public void test_validUsage() {
        ...
        compileTestBuilder
                ...
                .expectThatJavaFileObjectExists(
                        ...
                        "io.toolisticon.aptkkotlindemo.processor.tests.TestcaseValidUsageServiceLocator",
    ...
    public void test_shouldNotGenerateServiceLocator() {
        compileTestBuilder
                ...
                .compilationShouldSucceed()
                .expectThatGeneratedSourceFileDoesntExist("io.toolisticon.aptkkotlindemo.processor.tests.TestcaseGenerateNoServiceLocatorServiceLocator")
                .executeTest();
    }
