...
public class NewServiceProcessorTest {
    ...
    public void test_valid_usage() {
        ...
        compileTestBuilder
                ...
                .expectThatFileObjectExists(StandardLocation.CLASS_OUTPUT, "META-INF.services", "io.toolisticon.aptkkotlindemo.processor.serviceprocessortest.TestSpi", JavaFileObjectUtils.readFromString("testcase", "io.toolisticon.aptkkotlindemo.processor.tests.TestcaseValidUsage\n"))
                .expectThatFileObjectExists(StandardLocation.CLASS_OUTPUT, "META-INF.services", "io.toolisticon.aptkkotlindemo.processor.serviceprocessortest.TestSpi", new GeneratedFileObjectMatcher<FileObject>() {
                    @Override
